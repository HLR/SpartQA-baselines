...
from train import question_to_sentence, F1_measure, precision, recall, confusion_matrix
...
#             if unseen:
#                 with open('dataset/SpRL_annotation_unseen_test') as json_file:
...
#                     data = json.load(json_file)
#             else:
#                 with open('dataset/SpRL_annotation_'+test_or_dev+'.json') as json_file:
#                     data = json.load(json_file)
...
#                     _, output, truth = token_classification(model, sentence, traj_ind, land_ind, spatial_ind , other, device, file)

#                     print("truth: ", truth, "\npredict: ", output, file = file)
#                     _correct = correct 
#                     correct, TP,TPFP,TPFN = confusion_matrix(truth, output,correct, TP,TPFP,TPFN)
#                     if correct == _correct: print('Incorrect', file= file)
...
#             #precision
#             p = precision(TP,TPFP)
# #             print(test_or_dev,' Precision: ', p)
#             print(test_or_dev,' Precision: ', p, file=file)

#             #recall
#             r = recall(TP,TPFN)
# #             print(test_or_dev,' Recall: ', r)
#             print(test_or_dev,' Recall: ', r, file=file)

#             #f1
#             f= F1_measure(TP,TPFP, TPFN)
# #             print(test_or_dev,' F1: ', f)
#             print(test_or_dev,' F1: ', f, file=file)

#             #macro-f1
#             mf = F1_measure(TP,TPFP, TPFN, macro = True)
#             print(test_or_dev,' Macro-F1: ', mf)
#             print(test_or_dev,' Macro-F1: ', mf, file=file)
            
#             print(test_or_dev,' accuracy: ', correct / all_q, file=file)
...
# test(model, pretrain, baseline, test_or_dev,num_sample, unseen, qtype, other, human, device, file)
def test(model, pretrain, baseline, test_or_dev,num_sample,unseen, qtype, other, human,device, file):
